...
// Add starts watching the specified directory for newly created files
// (non-recursively).
func (w *Watcher) Add(name string) error {
	...
	const agnosticEvents = syscall.IN_MOVED_TO | syscall.IN_CREATE
...
// Remove stops watching the specified directory (non-recursively).
